...
export const ENDPOINTS = {
  ...
  SALES: {
    ...
    CUSTOMER: (id: string) => `sales/customers/${id}`,
    CUSTOMER_SUMMARY: (id: string) => `sales/customers/${id}/summary`,
    CUSTOMER_LEDGER: (id: string) => `sales/customers/${id}/ledger`,
    CUSTOMER_SALES: (id: string) => `sales/customers/${id}/sales`,
    CUSTOMER_PAYMENTS: (id: string) => `sales/customers/${id}/payments`,
    CUSTOMER_RETURNS: (id: string) => `sales/customers/${id}/returns`,
    CUSTOMER_DAMAGES: (id: string) => `sales/customers/${id}/damages`,
    CUSTOMER_ACTIVITIES: (id: string) => `sales/customers/${id}/activities`,
  },
  NOTIFICATIONS: {
