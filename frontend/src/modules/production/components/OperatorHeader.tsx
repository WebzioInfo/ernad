      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 border-l border-gray-200/60 pl-5 ml-1">
          <div className="text-right mr-2 hidden sm:block">
            ...
            {recentHandover && (
              <p className="text-[9px] font-bold text-[#1A9A91] tracking-wide uppercase mt-1">
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="px-3 py-2.5 bg-[#1A9A91] hover:bg-[#157C75] text-white font-bold text-xs uppercase tracking-wider rounded-[12px] active:scale-95 transition-all shadow-[0_2px_8px_rgba(26,154,145,0.22)] disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
              ...
              disabled={isLoggingOut}
              className="px-3 py-2.5 bg-white text-[#1A9A91] font-bold text-xs uppercase tracking-wider rounded-[12px] hover:bg-[#1A9A91]/5 active:scale-95 transition-all border border-[#1A9A91]/25 shadow-[0_2px_8px_rgba(0,0,0,0.04)] disabled:opacity-50 disabled:cursor-not-allowed"
